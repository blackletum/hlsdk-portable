...
public:
	...
	int ShouldAdvanceRoute(float flWaypointDist);
	int LookupFloat();
...
int CControllerExterminator::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
