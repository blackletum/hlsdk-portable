...
void CInfoTG::KeyValue(KeyValueData* pkvd)
{
...
void CTwinGonarch::KeyValue(KeyValueData* pkvd)
{
#if 0
...
int CTwinGonarch::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
